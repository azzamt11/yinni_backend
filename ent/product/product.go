...
const (
	...
	FieldImages = "images"
	// FieldProductDetails holds the string denoting the product_details field in the database.
	FieldProductDetails = "product_details"
...
//
//	import _ "yinni_backend/ent/runtime"
var (
	Hooks [2]ent.Hook
